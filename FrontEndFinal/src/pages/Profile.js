  ...
  return (
    <div className="flex flex-col">
      <div className="flex-1 overflow-y-auto bg-gray-50 sm:grid sm:grid-cols-2">
        <div class="p-8 md:p-12 lg:px-16 bg-slate-100 justify-center items-center flex">
          <div class="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <div className="flex flex-row items-center justify-center gap-3">
              ...
              <div class="mt-4 md:mt-8 inline-block rounded bg-teal-600 px-12 py-3 text-lg font-medium text-white transition hover:bg-yellow-400 focus:outline-none focus:ring focus:ring-yellow-400 cursor-pointer">
                <p onClick={()=>setEditProfileOverlay(true)}>Edit Profile</p>
              </div>
            </div>
          </div>
        </div>
        ...
        />
        {editProfileOverlay &&
          <OverlayWrapper closeFunction={()=>setEditProfileOverlay(false)}>
